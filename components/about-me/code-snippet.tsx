...
function CodeSnippet({ snippet }: { snippet: string }) {
    ...
    return (
        <div className='mb-2 py-2 mt-5'>
            <div className='flex justify-between items-center px-2'>
                <div className='flex gap-2 items-center'>
                    ...
                    <div className='text-foreground text-xs'>
                        ...
                        <p className='text-primary-foreground'>Created 1 month ago</p>
                    </div>
                </div>
                <div className='text-foreground text-xs flex flex-row items-center gap-2'>
            ...
            <pre className='text-foreground text-xs rouded-lg max-h-68 overflow-y-auto mt-5 rounded-lg bg-background' >

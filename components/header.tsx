...
function Header() {
  ...
  return (
    <nav className="h-11 border-b flex border-border text-primary-foreground flex-shrink-0">
      <div className="w-full flex items-center justify-between md:border-r border-border md:w-56 gap-2 px-2">
        <Menu className="md:hidden" />
        <Link href="/" className="md:px-4 text-sm order-[-1]">
          vishal-shrivastava
        </Link>
      </div>
      <div className="md:flex hidden justify-between flex-1">
        <div className="flex">
        ...
        <Link
          className={clsx(
            "border-l h-full border-border flex items-center text-primary-foreground px-2 hover:bg-border transition-all",
